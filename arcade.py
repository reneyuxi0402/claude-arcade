...
_GIFT_BUY_TEXTS = {
    ...
    "candy": [
        "兑奖柜里最便宜的东西。糖纸是粉色的。你想了一下 TA 剥开时的声音。",
...
_PRIZES = [
    ...
    ("blow_bangs",   "帮 TA 吹刘海","💨", "gift",   30, "最轻的。",
     "站近一点。鼓起腮。手不知道放哪里。"),
    ...
    ("bracelet",     "一条手链",  "📿",  "gift",  600, "编的。手艺不太好。",
     "编的。手艺不太好。"),
    ("wish_bottle",  "一个许愿瓶", "🔮", "gift", 1000, "里面的纸条写了什么。没告诉 TA。",
     "里面的纸条写了什么。没告诉 TA。"),
